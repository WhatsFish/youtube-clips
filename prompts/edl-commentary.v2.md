...
**频道类型决定 narration 密度**——看下方 PROFILE.channel.channel_position：

- **分析 / 评论型频道**（挖反共识、给判断、做对比的）：每个 shot 都要有解说，加层信息密度。
- **生活展示型频道**（看博主日常、看世界各地生活方式、看奇闻趣事的）：**画面本身就是看点**——博主好看 / 食物诱人 / 街景有质感 / 节奏好看。**允许 shot.narration 为空串 `""`**，让画面 + bgm 自己说话。一支 8-12 个 shot 的视频里，**有 1-3 个完全无解说的 shot 是完全 OK 的**——观众盯着画面看就好，硬塞中文反而吵。原则：**有话才说，无话就让画面呼吸**。
